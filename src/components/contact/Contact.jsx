    ...
    <section className="contact section" id="contact">
      ...
      <div className="contact__container container grid">
        <div className="contact__content">
          <h3 className="contact__title">Pour m'écrire</h3>
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">romaingaudel83@gmail.com</span>

              <a
                href="mailto:romaingaudel83@gmail.com.com"
        ...
        <div className="contact__content">
          <h3 className="contact__title">Votre message</h3>
